...
const Elemental = () => {
  ...
  const tabContents = [
    ...
    <div key="2" className="general">
      ...
      {fundTab === 2 && elemental.userSelectedDepositInfo && (
        <div className="claim-reward">
          ...
          <div className="subTabContent">
              ...
              {accountForDecimal(
                Number(
                  elemental.getUserWithdrawAmountWithYield(
                    +elemental.userSelectedDepositInfo.amount
                  )
                )
              ...
              <Button
                disabled={
                  !(
                    ...
                    +elemental.userSelectedDepositInfo.amount > 0
                  )
                }
                onClick={() => handleClaim()}
              >
            ...
            <div className="subTabInfo">
              {/* <h2>Notes</h2>
              <p>
                * You can only request to unstake after the next epoch starts.
              </p> */}
            </div>
          </div>
        </div>
              ...
              <p
                onClick={() =>
                  handleInputChange(
                    Number(
                      elemental
                        .getUserWithdrawAmountWithYield(
                          +elemental.selectedVault.vault!.amountCollected -
                ...
                <div className="extraInfo">
                  ...
                  <div className="epochInfo">
                    <p>
                      ...
                      {elemental.selectedVault.vault
                        ? new Date(
                            Number(elemental.selectedVault.vault.startDate)
                          )
                            .toLocaleDateString(undefined, {
                              year: "numeric",
                              month: "numeric",
